        ...
        <nav className='bg-black p-4 sticky z-1 top-0 text-white'>
            <div className='container mx-auto flex justify-between items-center'>
                ...
                <ul className='hidden md:flex space-x-4'>
                    ...
                    <li><a href="/contact" className={`p-4 transition-all duration-300 ${location.pathname=='/contact' ? 'text-indigo-300' : ''} hover:text-indigo-500`}>Contacto</a></li>
                </ul>                
            </div>
            <div className={`md:hidden transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-40' : 'max-h-0'}`}>
                <ul className='flex gap-5 flex-col items-center p-4 space-y-2'>
                    ...
                    <li><a href="/contact" className={`p-2 pr-4 pl-4 hover:text-indigo-500 transition-all duration-300 ${location.pathname=='/contact' ? 'text-indigo-300' : ''}`}>Contacto</a></li>
                </ul>           
            </div>         
        </nav>
    );
